...
/**
 * handle_write_char - Function prints character
 * @c: character types.
...
/**
 * write_num - Function write number using the bufffer
...
/**
 * write_unsgnd - Function writes unsigned number
...
/**
 * write_pointer - Function that writes memory address
 * @buffer: Arrays of characters
 * @ind: Index at which number starts in the buffer
 * @length: Length of number
 * @width: Wwidth specificaton
 * @flags: Active flags specification
 * @padd: This character represent the padding
